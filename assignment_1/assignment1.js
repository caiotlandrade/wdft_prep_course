...
/*
Exercise #2
Using the loop provided for you below, use an array's push method to insert the numbers  0 to 10 into positions 0 through 10 of the numbers array you just initialized above.'If you're not sure how to use the array push method go back and re read this module on data structures.'
*/

for(var i=0;i<=10;i++){ //I changed the for loop because it was pushing only until 9 and the exercise asked to insert the numbers 0 to 10
...
console.log(sum); //If I had kept the original for loop, the sum would have been 45
